...
export default function UsersDevicesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UsersDevices(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UsersDevicesCreateForm")}
      {...rest}
    >
      <ArrayField
